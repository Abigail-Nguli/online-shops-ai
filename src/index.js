...
function getshop(event) {
  ...
  then a brief explanation about the platform and its services and products(should not exceed 3 lines and lines should be separated by <br>),
  it should also include a link to the shopping platform with the following text: <div class="site-link">👉<a>Visit [title of the shopping platform] NOW(this should be active link to the shopping platform)</a>👈</div>, 
  the last line should be: <div class="sign-off"> ❤️Happy Shopping❤️</div>`;
